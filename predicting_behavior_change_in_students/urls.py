...
urlpatterns = [
    ...
    re_path(r'^Predict_Student_Behavior_Change_Type/$', remoteuser.Predict_Student_Behavior_Change_Type, name="Predict_Student_Behavior_Change_Type"),
    ...
    re_path(r'^View_Student_Behavior_Type_Ratio/$', serviceprovider.View_Student_Behavior_Type_Ratio, name="View_Student_Behavior_Type_Ratio"),
    re_path(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    re_path(r'^View_Prediction_Of_Student_Behavior_Type/$', serviceprovider.View_Prediction_Of_Student_Behavior_Type, name="View_Prediction_Of_Student_Behavior_Type"),
